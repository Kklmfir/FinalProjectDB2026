...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($validation['errors']) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE Transactions SET Pocket_ID = ?, Category_ID = ?, Sub_Category_ID = ?, Amount = ?, Transaction_Date = ?, Type = ?, Description = ? WHERE Transaction_ID = ?");
            $stmt->execute([
                $formData['pocket_id'],
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-0 text-gray-800">
                    <i class="fas fa-edit text-primary"></i> Edit Transaction
                </h1>
...
<div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control <?php echo in_array('Transaction date is required', $errors) ? 'is-invalid' : ''; ?>"
                                       ...
                                       value="<?php echo htmlspecialchars($formData['Transaction_Date']); ?>">
                                <div class="invalid-feedback">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <p><strong>ID:</strong> <?php echo $transaction['Transaction_ID']; ?></p>
                <p><strong>Created:</strong> <?php echo formatDate($transaction['Transaction_Date']); ?></p>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <ul class="small">
                    <li>Changing transaction type affects financial calculations</li>
                    <li>Update categories if better classification is available</li>
                    <li>Modify amounts only if corrections are needed</li>
